        ...
        impl CommandHandler for StatusHandler {
            ...
            fn info(&self) -> io::Result<Info> {
                Ok(Info {
                    ...
                    gateway_relay_health: "unknown".to_string(),
                    gateway_last_probe_rtt_ms: None,
                    gateway_probe_failures: 0,
                    gateway_relay_send_failures: 0,
                    gateway_last_error: None,
                    gateway_last_error_kind: None,
                    gateway_last_error_at_unix_ms: 0,
                    gateway_error_count: 0,
                    gateway_auth_rejected_count: 0,
                    gateway_configured_count: 0,
                    gateway_auth_status_detail: None,
