...
pub struct GatewayChannel {
    ...
    // @@protoc_insertion_point(field:GatewayChannel.udp_public_key)
    pub udp_public_key: ::std::vec::Vec<u8>,
    // @@protoc_insertion_point(field:GatewayChannel.udp_key_id)
    pub udp_key_id: ::std::string::String,
    // special fields
...
impl GatewayChannel {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "udp_public_key",
            |m: &GatewayChannel| { &m.udp_public_key },
            |m: &mut GatewayChannel| { &mut m.udp_public_key },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "udp_key_id",
            |m: &GatewayChannel| { &m.udp_key_id },
            |m: &mut GatewayChannel| { &mut m.udp_key_id },
        ));
...
impl ::protobuf::Message for GatewayChannel {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                42 => {
                    self.udp_public_key = is.read_bytes()?;
                },
                50 => {
                    self.udp_key_id = is.read_string()?;
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.udp_public_key.is_empty() {
            my_size += ::protobuf::rt::bytes_size(5, &self.udp_public_key);
        }
        if !self.udp_key_id.is_empty() {
            my_size += ::protobuf::rt::string_size(6, &self.udp_key_id);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        self.special_fields.cached_size().set(my_size as u32);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.udp_public_key.is_empty() {
            os.write_bytes(5, &self.udp_public_key)?;
        }
        if !self.udp_key_id.is_empty() {
            os.write_string(6, &self.udp_key_id)?;
        }
        os.write_unknown_fields(self.special_fields.unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn clear(&mut self) {
        ...
        self.udp_public_key.clear();
        self.udp_key_id.clear();
        self.special_fields.clear();
    }
    ...
    fn default_instance() -> &'static GatewayChannel {
        static instance: GatewayChannel = GatewayChannel {
            ...
            udp_public_key: ::std::vec::Vec::new(),
            udp_key_id: ::std::string::String::new(),
            special_fields: ::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
pub struct GatewayAccessGrant {
    ...
    // @@protoc_insertion_point(field:GatewayAccessGrant.gateway_channel)
    pub gateway_channel: ::protobuf::MessageField<GatewayChannel>,
...
impl GatewayAccessGrant {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, GatewayChannel>(
            "gateway_channel",
            |m: &GatewayAccessGrant| { &m.gateway_channel },
            |m: &mut GatewayAccessGrant| { &mut m.gateway_channel },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "gateway_id",
...
impl ::protobuf::Message for GatewayAccessGrant {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                74 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.gateway_channel)?;
                },
                106 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.gateway_channel.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        }
    ...
    fn default_instance() -> &'static GatewayAccessGrant {
        static instance: GatewayAccessGrant = GatewayAccessGrant {
            ...
            gateway_channel: ::protobuf::MessageField::none(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0edeadlineUnixMs\x12:\n\x0etrigger_reason\x18\x0b\x20\x01(\x0e2\x13.Pu\
    nchTriggerReasonR\rtriggerReason\x12%\n\x0eattempt_budget\x18\x0c\x20\
    \x01(\rR\rattemptBudget\x12Y\n\x19endpoint_selection_policy\x18\r\x20\
    \x01(\x0e2\x1d.PunchEndpointSelectionPolicyR\x17endpointSelectionPolicy\
    \"\xb9\x01\n\x08PunchAck\x12\x1d\n\nsession_id\x18\x01\x20\x01(\x04R\tse\
    ssionId\x12\x16\n\x06source\x18\x02\x20\x01(\x07R\x06source\x12\x18\n\
    \x07attempt\x18\x03\x20\x01(\rR\x07attempt\x12\x1a\n\x08accepted\x18\x04\
    \x20\x01(\x08R\x08accepted\x12\x16\n\x06reason\x18\x05\x20\x01(\tR\x06re\
    ason\x12(\n\x05phase\x18\x06\x20\x01(\x0e2\x12.PunchSessionPhaseR\x05pha\
    se\"\xb3\x03\n\nPunchStart\x12\x1d\n\nsession_id\x18\x01\x20\x01(\x04R\t\
    sessionId\x12\x16\n\x06source\x18\x02\x20\x01(\x07R\x06source\x12\x16\n\
    \x06target\x18\x03\x20\x01(\x07R\x06target\x125\n\x0epeer_endpoints\x18\
    \x04\x20\x03(\x0b2\x0e.PunchEndpointR\rpeerEndpoints\x12\x18\n\x07attemp\
    t\x18\x05\x20\x01(\rR\x07attempt\x12\x1d\n\ntimeout_ms\x18\x06\x20\x01(\
    \rR\ttimeoutMs\x12(\n\x10deadline_unix_ms\x18\x07\x20\x01(\x03R\x0edeadl\
    ineUnixMs\x12:\n\x0etrigger_reason\x18\x08\x20\x01(\x0e2\x13.PunchTrigge\
    rReasonR\rtriggerReason\x12%\n\x0eattempt_budget\x18\t\x20\x01(\rR\ratte\
    mptBudget\x12Y\n\x19endpoint_selection_policy\x18\n\x20\x01(\x0e2\x1d.Pu\
    nchEndpointSelectionPolicyR\x17endpointSelectionPolicy\"\x9b\x02\n\x0bPu\
    nchResult\x12\x1d\n\nsession_id\x18\x01\x20\x01(\x04R\tsessionId\x12\x16\
    \n\x06source\x18\x02\x20\x01(\x07R\x06source\x12\x16\n\x06target\x18\x03\
    \x20\x01(\x07R\x06target\x12\x18\n\x07attempt\x18\x04\x20\x01(\rR\x07att\
    ...
    \x20\x01(\x0e2\r.PunchNatTypeR\x07natType\x12@\n\x14public_udp_endpoints\
    \x18\n\x20\x03(\x0b2\x0e.PunchEndpointR\x12publicUdpEndpoints\x12E\n\x14\
