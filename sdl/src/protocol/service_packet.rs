...
impl From<u8> for Protocol {
    fn from(value: u8) -> Self {
        match value {
            ...
            27 => Self::DeviceRenameRequest,
            28 => Self::DeviceRenameResponse,
            29 => Self::DebugCollectRequest,
            30 => Self::DebugCollectResponse,
            31 => Self::DebugWatchStartRequest,
            32 => Self::DebugWatchStartResponse,
            33 => Self::DebugWatchStopRequest,
            34 => Self::DebugWatchStopResponse,
            35 => Self::DebugWatchEvent,
...
impl Into<u8> for Protocol {
    fn into(self) -> u8 {
        match self {
            ...
            Self::DeviceRenameRequest => 27,
            Self::DeviceRenameResponse => 28,
            Self::DebugCollectRequest => 29,
            Self::DebugCollectResponse => 30,
            Self::DebugWatchStartRequest => 31,
            Self::DebugWatchStartResponse => 32,
            Self::DebugWatchStopRequest => 33,
            Self::DebugWatchStopResponse => 34,
            Self::DebugWatchEvent => 35,
...
mod tests {
    ...
    fn punch_protocol_mapping_roundtrip() {
        let cases = [
            ...
            (27u8, Protocol::DeviceRenameRequest),
            (28u8, Protocol::DeviceRenameResponse),
            (29u8, Protocol::DebugCollectRequest),
            (30u8, Protocol::DebugCollectResponse),
            (31u8, Protocol::DebugWatchStartRequest),
            (32u8, Protocol::DebugWatchStartResponse),
            (33u8, Protocol::DebugWatchStopRequest),
            (34u8, Protocol::DebugWatchStopResponse),
            (35u8, Protocol::DebugWatchEvent),
